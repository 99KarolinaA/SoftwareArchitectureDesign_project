package mk.ukim.finki.dians.allparkings.service.impl;

import mk.ukim.finki.dians.allparkings.model.Parking;
import mk.ukim.finki.dians.allparkings.model.ParkingNotFoundException;
import mk.ukim.finki.dians.allparkings.repository.ParkingRepository;
...
public class ParkingServiceImpl implements ParkingService {
    ...
    public List<Parking> findAllByCityOrAndAddressSorted(String city, String address, String sort) {
        ...
        if (!city.isEmpty() && !city.equals("empty") && !address.isEmpty() && !address.equals("empty")) {
        ...
        } else if (!city.isEmpty() && !city.equals("empty")) {
        ...
        } else if (!address.isEmpty() && !address.equals("empty")) {
